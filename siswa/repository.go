...
func (r *repository) SearchFilter(siswa Siswa) ([]ResultEntity, error) {
	...
	if siswa.ID_kota == 0 && (nama == "" && nrp != "") {
		q = fmt.Sprintf("Select `merged`.`id_siswa`, `merged`.`nama`, `merged`.`nrp`,MAX(CASE WHEN `merged`.`id_mapel` = \"1\" THEN `merged`.`score` ELSE 0 END) AS \"Fisika\",MAX(CASE WHEN `merged`.`id_mapel` = \"2\" THEN `merged`.`score` ELSE 0 END) AS \"Kimia\",MAX(CASE WHEN `merged`.`id_mapel` = \"3\" THEN `merged`.`score` ELSE 0 END) AS \"Matematika\",MAX(CASE WHEN `merged`.`id_mapel` = \"4\" THEN `merged`.`score` ELSE 0 END) AS \"Biologi\",MAX(CASE WHEN `merged`.`id_mapel` = \"5\" THEN `merged`.`score` ELSE 0 END) AS \"Agama\",MAX(CASE WHEN `merged`.`id_mapel` = \"6\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Indonesia\",MAX(CASE WHEN `merged`.`id_mapel` = \"7\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Inggris\" FROM merged WHERE `merged`.`nama` LIKE \"%%\" AND `merged`.`nrp` LIKE \"%s\" GROUP BY `merged`.`id_siswa`", nrp)

	} else if siswa.ID_kota == 0 && (nama != "" && nrp == "") {
		fmt.Println(nama)
		q = fmt.Sprintf("Select `merged`.`id_siswa`, `merged`.`nama`, `merged`.`nrp`,MAX(CASE WHEN `merged`.`id_mapel` = \"1\" THEN `merged`.`score` ELSE 0 END) AS \"Fisika\",MAX(CASE WHEN `merged`.`id_mapel` = \"2\" THEN `merged`.`score` ELSE 0 END) AS \"Kimia\",MAX(CASE WHEN `merged`.`id_mapel` = \"3\" THEN `merged`.`score` ELSE 0 END) AS \"Matematika\",MAX(CASE WHEN `merged`.`id_mapel` = \"4\" THEN `merged`.`score` ELSE 0 END) AS \"Biologi\",MAX(CASE WHEN `merged`.`id_mapel` = \"5\" THEN `merged`.`score` ELSE 0 END) AS \"Agama\",MAX(CASE WHEN `merged`.`id_mapel` = \"6\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Indonesia\",MAX(CASE WHEN `merged`.`id_mapel` = \"7\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Inggris\" FROM merged WHERE `merged`.`nama` LIKE \"%s\" AND `merged`.`nrp` LIKE \"%%\" GROUP BY `merged`.`id_siswa`", nama)

	} else if siswa.ID_kota == 0 && (nama != "" && nrp != "") {
		q = fmt.Sprintf("Select `merged`.`id_siswa`, `merged`.`nama`, `merged`.`nrp`,MAX(CASE WHEN `merged`.`id_mapel` = \"1\" THEN `merged`.`score` ELSE 0 END) AS \"Fisika\",MAX(CASE WHEN `merged`.`id_mapel` = \"2\" THEN `merged`.`score` ELSE 0 END) AS \"Kimia\",MAX(CASE WHEN `merged`.`id_mapel` = \"3\" THEN `merged`.`score` ELSE 0 END) AS \"Matematika\",MAX(CASE WHEN `merged`.`id_mapel` = \"4\" THEN `merged`.`score` ELSE 0 END) AS \"Biologi\",MAX(CASE WHEN `merged`.`id_mapel` = \"5\" THEN `merged`.`score` ELSE 0 END) AS \"Agama\",MAX(CASE WHEN `merged`.`id_mapel` = \"6\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Indonesia\",MAX(CASE WHEN `merged`.`id_mapel` = \"7\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Inggris\" FROM merged WHERE `merged`.`nama` LIKE \"%s\" AND `merged`.`nrp` LIKE \"%s\" GROUP BY `merged`.`id_siswa`", nama, nrp)

	} else if siswa.ID_kota == 0 {
		// search from all tables
		q = fmt.Sprintf("Select `merged`.`id_siswa`, `merged`.`nama`, `merged`.`nrp`,MAX(CASE WHEN `merged`.`id_mapel` = \"1\" THEN `merged`.`score` ELSE 0 END) AS \"Fisika\",MAX(CASE WHEN `merged`.`id_mapel` = \"2\" THEN `merged`.`score` ELSE 0 END) AS \"Kimia\",MAX(CASE WHEN `merged`.`id_mapel` = \"3\" THEN `merged`.`score` ELSE 0 END) AS \"Matematika\",MAX(CASE WHEN `merged`.`id_mapel` = \"4\" THEN `merged`.`score` ELSE 0 END) AS \"Biologi\",MAX(CASE WHEN `merged`.`id_mapel` = \"5\" THEN `merged`.`score` ELSE 0 END) AS \"Agama\",MAX(CASE WHEN `merged`.`id_mapel` = \"6\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Indonesia\",MAX(CASE WHEN `merged`.`id_mapel` = \"7\" THEN `merged`.`score` ELSE 0 END) AS \"Bahasa_Inggris\" FROM merged WHERE `merged`.`nama` LIKE \"%%\" AND `merged`.`nrp` LIKE \"%%\" GROUP BY `merged`.`id_siswa`")
